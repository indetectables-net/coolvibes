    ...
    begin
      ...
      while sock.Connected do
        begin
          ...
          //Copy copia la información del string recibido del Cliente:
          //  Copy(String, Posición, Nº_Caracteres)
          if Copy(Recibido, 1, 8) = 'MAININFO' then
            begin
              //Delete borra la información del string recibido del Cliente:
              //  Delete(String, Posición, Nº_Caracteres)
