...
begin
  ...
  if (h <> 0) then
    begin
      Result := 'ERROR1';
      Exit;
    end; //Formato no compatible con el dispositivo
  ...
  if (h <> 0) then
    begin
      Result := 'ERROR2';
      Exit;
    end; //Error al intentar crear el handle
  ...
  if (h <> 0) then
    begin
      Result := 'ERROR3';
      Exit;
    end; //Error al intentar preparar los headers
  ...
  if (h <> 0) then
    begin
      Result := 'ERROR4';
      Exit;
    end; //Error al intentar mandarle el buffer
  ...
  if (h <> 0) then
    begin
      Result := 'ERROR5';
      Exit;
    end; //Error al intentar comenzar a grabar..
  Result := Result + '|';
